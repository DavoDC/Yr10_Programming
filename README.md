...
| Program | Description |
|---------|-------------|
| `Calculator Mark 1` | Basic arithmetic calculator |
| `Calculator Mark 2` | Improved calculator (Mark 2 iteration) |
| `Area Calculator - Trapezoid` | Calculates the area of a trapezoid from user input |
| `Volume Calculator - Cone` | Calculates the volume of a cone from user input |
| `Temperature Converter` | Converts between temperature units |
| `Time Converter` | Converts between time units |
